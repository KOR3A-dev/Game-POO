...
import 'package:game_poo/levels/advance_level/design_patterns.dart';
...
class _AbstractionState extends State<Abstraction> {
  ...
  List<Response> questions = [
    Response(
      question:
          "Explica qué es la abstracción en la programación orientada a objetos.",
      options: [
        Option(
          letter: 'a',
          option: "Abstracción es el proceso de definir múltiples clases en un programa.",
          isCorrect: false,
        ),
        Option(
          letter: 'b',
          option: "Abstracción es el proceso de encapsular datos en una clase.",
          isCorrect: false,
        ),
        Option(
          letter: 'c',
          option: "Abstracción es el proceso de ocultar los detalles de implementación y solo mostrar las características esenciales de un objeto.",
          isCorrect: true,
        ),
      ],
    ),
  ...
  void _doSomething() async {
    ...
    Timer(const Duration(seconds: 6), () {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const DesignPatterns()),
      );
    });
  }
