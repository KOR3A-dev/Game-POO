...
import 'package:game_poo/levels/intermediate_level/polymorphism.dart';
...
class _InheritanceState extends State<Inheritance> {
  ...
  List<Response> questions = [
    Response(
      ...
      options: [
        Option(
          letter: 'a',
          option: "La capacidad de una clase para contener atributos y métodos.",
          isCorrect: false,
        ),
        Option(
          letter: 'b',
          option: "La habilidad de una clase para crear múltiples instancias de sí misma.",
          isCorrect: false,
        ),
        Option(
          letter: 'c',
  ...
  void _doSomething() async {
    ...
    Timer(const Duration(seconds: 6), () {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const Polymorphism()),
      );
    });
  }
