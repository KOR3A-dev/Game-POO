...
class Solid extends StatefulWidget {
  const Solid({Key? key}) : super(key: key);
...
class _SolidState extends State<Solid> {
  ...
  List<Response> questions = [
    Response(
      question:
          "¿Cuál es el beneficio de seguir los principios SOLID en el desarrollo de software?",
      options: [
        Option(
          letter: 'a',
          option: "Facilitan el mantenimiento, la extensibilidad y la reutilización del código.",
          isCorrect: false,
        ),
        Option(
          letter: 'b',
          option: "No hay beneficios en seguir los principios SOLID",
          isCorrect: true,
        ),
        Option(
          letter: 'c',
          option: " Incrementan la complejidad del código y hacen que sea más difícil de entender",
          isCorrect: false,
        ),
      ],
    ),
