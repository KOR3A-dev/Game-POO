...
import 'package:game_poo/levels/advance_level/solid.dart';
...
class DesignPatterns extends StatefulWidget {
  const DesignPatterns({Key? key}) : super(key: key);
...
class _DesignPatternsState extends State<DesignPatterns> {
  ...
  List<Response> questions = [
    Response(
      ...
      options: [
        Option(
          letter: 'a',
          option: "Funciones predefinidas que están disponibles en todos los lenguajes de programación.",
          isCorrect: false,
        ),
        Option(
          letter: 'b',
          option: "Soluciones generales a problemas comunes que surgen durante el diseño de software",
          isCorrect: true,
        ),
        Option(
          letter: 'c',
          option: "Métodos para diseñar interfaces de usuario.",
          isCorrect: false,
        ),
      ],
    ),
  ...
  void _doSomething() async {
    ...
    Timer(const Duration(seconds: 6), () {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const Solid()),
      );
    });
  }
